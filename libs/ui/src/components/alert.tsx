...
const alertVariants = cva(
  "relative w-full rounded-lg border border-[hsl(var(--border))] px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-[hsl(var(--foreground))] [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
